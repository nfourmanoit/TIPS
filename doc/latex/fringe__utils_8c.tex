\hypertarget{fringe__utils_8c}{
\section{/renoir/fourmano/Desktop/OUSIM/TIPS/branches/tips\_\-build/src/axesim/fringe\_\-utils.c File Reference}
\label{fringe__utils_8c}\index{/renoir/fourmano/Desktop/OUSIM/TIPS/branches/tips\_\-build/src/axesim/fringe\_\-utils.c@{/renoir/fourmano/Desktop/OUSIM/TIPS/branches/tips\_\-build/src/axesim/fringe\_\-utils.c}}
}
...
{\ttfamily \#include \char`\"{}fringe\_\-utils.h\char`\"{}}\par
...
\begin{DoxyCompactItemize}
\item 
\#define \hyperlink{fringe__utils_8c_a74e75242132eaabbc1c512488a135926}{MIN}(x, y)~(((x)$<$(y))?(x):(y))
\item 
\#define \hyperlink{fringe__utils_8c_aacc3ee1a7f283f8ef65cea31f4436a95}{MAX}(x, y)~(((x)$>$(y))?(x):(y))
\end{DoxyCompactItemize}
\subsection*{Functions}
\begin{DoxyCompactItemize}
\item 
void \hyperlink{fringe__utils_8c_a0402175e645c022e7a90b0bbd64547a2}{fringe\_\-correct\_\-PET} (const \hyperlink{structfringe__conf}{fringe\_\-conf} $\ast$fconf, const \hyperlink{structbeam}{beam} act\_\-beam, \hyperlink{structap__pixel}{ap\_\-pixel} $\ast$obj\_\-pet, \hyperlink{structap__pixel}{ap\_\-pixel} $\ast$bck\_\-pet)
\item 
gsl\_\-vector $\ast$$\ast$ \hyperlink{fringe__utils_8c_af355623cf6639eebf7762b3586e7fd30}{evaluate\_\-pixel\_\-throughput} (const \hyperlink{structfringe__conf}{fringe\_\-conf} $\ast$fconf, const \hyperlink{structbeam}{beam} act\_\-beam, const \hyperlink{structap__pixel}{ap\_\-pixel} $\ast$obj\_\-pix)
\item 
gsl\_\-vector $\ast$$\ast$ \hyperlink{fringe__utils_8c_a00c596a71399f5efbfba60c5afd12a14}{get\_\-gauss\_\-throughput} (const \hyperlink{structfringe__conf}{fringe\_\-conf} $\ast$fconf, const \hyperlink{structap__pixel}{ap\_\-pixel} $\ast$obj\_\-pix, const double fwhm)
\item 
\hyperlink{structinterpolator}{interpolator} $\ast$ \hyperlink{fringe__utils_8c_a5cc6f161f0e2a24a14a40e0ccc11d7b5}{create\_\-interp\_\-tput} (const \hyperlink{structpixel__tput}{pixel\_\-tput} $\ast$p\_\-tput)
\item 
void \hyperlink{fringe__utils_8c_a1f78b41444483fcce4645f0604c6228e}{compute\_\-pixel\_\-tput} (const \hyperlink{structbeam}{beam} act\_\-beam, const \hyperlink{structap__pixel}{ap\_\-pixel} $\ast$obj\_\-pix, \hyperlink{structpixel__tput}{pixel\_\-tput} $\ast$p\_\-tput)
\item 
\hyperlink{structd__point}{d\_\-point} \hyperlink{fringe__utils_8c_a900ec9c280d1f89d01b43fb28d2db9b3}{compute\_\-tput\_\-angles} (const \hyperlink{structbeam}{beam} act\_\-beam, const \hyperlink{structap__pixel}{ap\_\-pixel} $\ast$act\_\-pet)
\item 
\hyperlink{structpixel__tput}{pixel\_\-tput} $\ast$ \hyperlink{fringe__utils_8c_a2771bb1bda09da356c808194651cff4c}{alloc\_\-pixel\_\-tput} ()
\item 
void \hyperlink{fringe__utils_8c_a99e32a5f7e3cdc9a250e41c83b4b0cc2}{print\_\-pixel\_\-tput} (\hyperlink{structpixel__tput}{pixel\_\-tput} $\ast$p\_\-tput)
\item 
void \hyperlink{fringe__utils_8c_a5e1ffec6cdcba89f4d0ccc7d68a7ba2e}{free\_\-pixel\_\-tput} (\hyperlink{structpixel__tput}{pixel\_\-tput} $\ast$p\_\-tput)
\end{DoxyCompactItemize}


\subsection{Define Documentation}
\hypertarget{fringe__utils_8c_aacc3ee1a7f283f8ef65cea31f4436a95}{
\index{fringe\_\-utils.c@{fringe\_\-utils.c}!MAX@{MAX}}
\index{MAX@{MAX}!fringe_utils.c@{fringe\_\-utils.c}}
\subsubsection[{MAX}]{\setlength{\rightskip}{0pt plus 5cm}\#define MAX(x, \/  y)~(((x)$>$(y))?(x):(y))}}
\label{fringe__utils_8c_aacc3ee1a7f283f8ef65cea31f4436a95}
\hypertarget{fringe__utils_8c_a74e75242132eaabbc1c512488a135926}{
\index{fringe\_\-utils.c@{fringe\_\-utils.c}!MIN@{MIN}}
\index{MIN@{MIN}!fringe_utils.c@{fringe\_\-utils.c}}
\subsubsection[{MIN}]{\setlength{\rightskip}{0pt plus 5cm}\#define MIN(x, \/  y)~(((x)$<$(y))?(x):(y))}}
\label{fringe__utils_8c_a74e75242132eaabbc1c512488a135926}


\subsection{Function Documentation}
\hypertarget{fringe__utils_8c_a2771bb1bda09da356c808194651cff4c}{
\index{fringe\_\-utils.c@{fringe\_\-utils.c}!alloc\_\-pixel\_\-tput@{alloc\_\-pixel\_\-tput}}
\index{alloc\_\-pixel\_\-tput@{alloc\_\-pixel\_\-tput}!fringe_utils.c@{fringe\_\-utils.c}}
\subsubsection[{alloc\_\-pixel\_\-tput}]{\setlength{\rightskip}{0pt plus 5cm}{\bf pixel\_\-tput}$\ast$ alloc\_\-pixel\_\-tput ()}}
\label{fringe__utils_8c_a2771bb1bda09da356c808194651cff4c}
...
632 }
\end{DoxyCode}
\hypertarget{fringe__utils_8c_a1f78b41444483fcce4645f0604c6228e}{
\index{fringe\_\-utils.c@{fringe\_\-utils.c}!compute\_\-pixel\_\-tput@{compute\_\-pixel\_\-tput}}
\index{compute\_\-pixel\_\-tput@{compute\_\-pixel\_\-tput}!fringe_utils.c@{fringe\_\-utils.c}}
...
\label{fringe__utils_8c_a1f78b41444483fcce4645f0604c6228e}
...
573 }
\end{DoxyCode}
\hypertarget{fringe__utils_8c_a900ec9c280d1f89d01b43fb28d2db9b3}{
\index{fringe\_\-utils.c@{fringe\_\-utils.c}!compute\_\-tput\_\-angles@{compute\_\-tput\_\-angles}}
\index{compute\_\-tput\_\-angles@{compute\_\-tput\_\-angles}!fringe_utils.c@{fringe\_\-utils.c}}
...
\label{fringe__utils_8c_a900ec9c280d1f89d01b43fb28d2db9b3}
...
608 }
\end{DoxyCode}
\hypertarget{fringe__utils_8c_a5cc6f161f0e2a24a14a40e0ccc11d7b5}{
\index{fringe\_\-utils.c@{fringe\_\-utils.c}!create\_\-interp\_\-tput@{create\_\-interp\_\-tput}}
\index{create\_\-interp\_\-tput@{create\_\-interp\_\-tput}!fringe_utils.c@{fringe\_\-utils.c}}
...
\label{fringe__utils_8c_a5cc6f161f0e2a24a14a40e0ccc11d7b5}
...
497 }
\end{DoxyCode}
\hypertarget{fringe__utils_8c_af355623cf6639eebf7762b3586e7fd30}{
\index{fringe\_\-utils.c@{fringe\_\-utils.c}!evaluate\_\-pixel\_\-throughput@{evaluate\_\-pixel\_\-throughput}}
\index{evaluate\_\-pixel\_\-throughput@{evaluate\_\-pixel\_\-throughput}!fringe_utils.c@{fringe\_\-utils.c}}
...
\label{fringe__utils_8c_af355623cf6639eebf7762b3586e7fd30}
...
315 }
\end{DoxyCode}
\hypertarget{fringe__utils_8c_a5e1ffec6cdcba89f4d0ccc7d68a7ba2e}{
\index{fringe\_\-utils.c@{fringe\_\-utils.c}!free\_\-pixel\_\-tput@{free\_\-pixel\_\-tput}}
\index{free\_\-pixel\_\-tput@{free\_\-pixel\_\-tput}!fringe_utils.c@{fringe\_\-utils.c}}
...
\label{fringe__utils_8c_a5e1ffec6cdcba89f4d0ccc7d68a7ba2e}
...
673 }
\end{DoxyCode}
\hypertarget{fringe__utils_8c_a0402175e645c022e7a90b0bbd64547a2}{
\index{fringe\_\-utils.c@{fringe\_\-utils.c}!fringe\_\-correct\_\-PET@{fringe\_\-correct\_\-PET}}
\index{fringe\_\-correct\_\-PET@{fringe\_\-correct\_\-PET}!fringe_utils.c@{fringe\_\-utils.c}}
...
\label{fringe__utils_8c_a0402175e645c022e7a90b0bbd64547a2}
...
184 }
\end{DoxyCode}
\hypertarget{fringe__utils_8c_a00c596a71399f5efbfba60c5afd12a14}{
\index{fringe\_\-utils.c@{fringe\_\-utils.c}!get\_\-gauss\_\-throughput@{get\_\-gauss\_\-throughput}}
\index{get\_\-gauss\_\-throughput@{get\_\-gauss\_\-throughput}!fringe_utils.c@{fringe\_\-utils.c}}
...
\label{fringe__utils_8c_a00c596a71399f5efbfba60c5afd12a14}
...
441 }
\end{DoxyCode}
\hypertarget{fringe__utils_8c_a99e32a5f7e3cdc9a250e41c83b4b0cc2}{
\index{fringe\_\-utils.c@{fringe\_\-utils.c}!print\_\-pixel\_\-tput@{print\_\-pixel\_\-tput}}
\index{print\_\-pixel\_\-tput@{print\_\-pixel\_\-tput}!fringe_utils.c@{fringe\_\-utils.c}}
...
\label{fringe__utils_8c_a99e32a5f7e3cdc9a250e41c83b4b0cc2}

\hypertarget{spc__optimum_8c}{
\section{/renoir/fourmano/Desktop/OUSIM/TIPS/branches/tips\_\-build/src/axesim/spc\_\-optimum.c File Reference}
\label{spc__optimum_8c}\index{/renoir/fourmano/Desktop/OUSIM/TIPS/branches/tips\_\-build/src/axesim/spc\_\-optimum.c@{/renoir/fourmano/Desktop/OUSIM/TIPS/branches/tips\_\-build/src/axesim/spc\_\-optimum.c}}
}
...
\begin{DoxyCompactItemize}
\item 
\#define \hyperlink{spc__optimum_8c_aa7866fa5e4e0ee9b034e9dab6599a9cc}{SQR}(x)~((x)$\ast$(x))
\item 
\#define \hyperlink{spc__optimum_8c_a74e75242132eaabbc1c512488a135926}{MIN}(x, y)~(((x)$<$(y))?(x):(y))
\item 
\#define \hyperlink{spc__optimum_8c_aacc3ee1a7f283f8ef65cea31f4436a95}{MAX}(x, y)~(((x)$>$(y))?(x):(y))
\end{DoxyCompactItemize}
\subsection*{Functions}
\begin{DoxyCompactItemize}
\item 
\hyperlink{structdrzstamp}{drzstamp} $\ast$ \hyperlink{spc__optimum_8c_a4da3f4712620de5171d7a0daa5f0bf61}{compute\_\-modvar} (\hyperlink{structap__pixel}{ap\_\-pixel} $\ast$ap\_\-p, const \hyperlink{structbeam}{beam} actbeam, const \hyperlink{structdrzstamp__dim}{drzstamp\_\-dim} dimension)
\item 
void \hyperlink{spc__optimum_8c_aa3e8e6e9854df4de96ee44cbacfad4a8}{shift\_\-tracelength} (\hyperlink{structap__pixel}{ap\_\-pixel} $\ast$ap\_\-p, const double xi\_\-shift)
\item 
void \hyperlink{spc__optimum_8c_a1f6715d47ee4f6ff176974c14dc6401c}{prepare\_\-inv\_\-variance} (\hyperlink{structap__pixel}{ap\_\-pixel} $\ast$ap\_\-p, \hyperlink{structap__pixel}{ap\_\-pixel} $\ast$bg\_\-p, const int dobck, const \hyperlink{structaperture__conf}{aperture\_\-conf} $\ast$conf, const double exptime, const double sky\_\-cps, const double xi\_\-shift)
\item 
void \hyperlink{spc__optimum_8c_a507edca311317b7c885a40aff09a4e34}{compute\_\-object\_\-ivar} (\hyperlink{structap__pixel}{ap\_\-pixel} $\ast$ap\_\-p, const double rdnoise, const double exptime, const double sky\_\-cps)
\item 
void \hyperlink{spc__optimum_8c_aa900417c8629b95d35d362ca481c5483}{compute\_\-total\_\-ivar} (\hyperlink{structap__pixel}{ap\_\-pixel} $\ast$ap\_\-p, const \hyperlink{structap__pixel}{ap\_\-pixel} $\ast$bg\_\-p, const double rdnoise, const double exptime, const double sky\_\-cps)
\item 
\hyperlink{structdrzstamp}{drzstamp} $\ast$ \hyperlink{spc__optimum_8c_a1eb0bd08ffa79cfb7f96ebffcb3325c7}{alloc\_\-drzstamp} (const \hyperlink{structdrzstamp__dim}{drzstamp\_\-dim} dimension)
\item 
\hyperlink{structdrzstamp__dim}{drzstamp\_\-dim} \hyperlink{spc__optimum_8c_a1dc967d6de4c0d294342ef5124da686e}{get\_\-all\_\-dims} (const \hyperlink{structap__pixel}{ap\_\-pixel} $\ast$ap\_\-p, const \hyperlink{structap__pixel}{ap\_\-pixel} $\ast$bg\_\-p, const \hyperlink{structbeam}{beam} actbeam, const int dobck)
\item 
\hyperlink{structdrzstamp__dim}{drzstamp\_\-dim} \hyperlink{spc__optimum_8c_a925a44a925643f7770807b6352ae5109}{get\_\-resample\_\-dims} (const \hyperlink{structap__pixel}{ap\_\-pixel} $\ast$ap\_\-p, const \hyperlink{structbeam}{beam} actbeam)
\item 
\hyperlink{structdrzstamp__dim}{drzstamp\_\-dim} \hyperlink{spc__optimum_8c_a48973ed3e4aa7384e047f4d75ee06582}{get\_\-default\_\-dim} ()
\item 
\hyperlink{structdrzstamp}{drzstamp} $\ast$ \hyperlink{spc__optimum_8c_aef1186ac7f985de47fe8cd962a4381b8}{get\_\-default\_\-modvar} ()
\item 
gsl\_\-matrix $\ast$ \hyperlink{spc__optimum_8c_a6f7e58438e5ed0d86dcaa2f170db30c9}{get\_\-default\_\-weight} ()
\item 
gsl\_\-matrix $\ast$ \hyperlink{spc__optimum_8c_a670955b1949d9ed6a54528c55b2d7bfe}{comp\_\-allweight} (\hyperlink{structdrzstamp}{drzstamp} $\ast$modvar)
\end{DoxyCompactItemize}


\subsection{Define Documentation}
\hypertarget{spc__optimum_8c_aacc3ee1a7f283f8ef65cea31f4436a95}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!MAX@{MAX}}
\index{MAX@{MAX}!spc_optimum.c@{spc\_\-optimum.c}}
\subsubsection[{MAX}]{\setlength{\rightskip}{0pt plus 5cm}\#define MAX(x, \/  y)~(((x)$>$(y))?(x):(y))}}
\label{spc__optimum_8c_aacc3ee1a7f283f8ef65cea31f4436a95}
\hypertarget{spc__optimum_8c_a74e75242132eaabbc1c512488a135926}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!MIN@{MIN}}
\index{MIN@{MIN}!spc_optimum.c@{spc\_\-optimum.c}}
\subsubsection[{MIN}]{\setlength{\rightskip}{0pt plus 5cm}\#define MIN(x, \/  y)~(((x)$<$(y))?(x):(y))}}
\label{spc__optimum_8c_a74e75242132eaabbc1c512488a135926}
\hypertarget{spc__optimum_8c_aa7866fa5e4e0ee9b034e9dab6599a9cc}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!SQR@{SQR}}
\index{SQR@{SQR}!spc_optimum.c@{spc\_\-optimum.c}}
\subsubsection[{SQR}]{\setlength{\rightskip}{0pt plus 5cm}\#define SQR(x)~((x)$\ast$(x))}}
\label{spc__optimum_8c_aa7866fa5e4e0ee9b034e9dab6599a9cc}


\subsection{Function Documentation}
\hypertarget{spc__optimum_8c_a1eb0bd08ffa79cfb7f96ebffcb3325c7}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!alloc\_\-drzstamp@{alloc\_\-drzstamp}}
\index{alloc\_\-drzstamp@{alloc\_\-drzstamp}!spc_optimum.c@{spc\_\-optimum.c}}
...
\label{spc__optimum_8c_a1eb0bd08ffa79cfb7f96ebffcb3325c7}
...
375 }
\end{DoxyCode}
\hypertarget{spc__optimum_8c_a670955b1949d9ed6a54528c55b2d7bfe}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!comp\_\-allweight@{comp\_\-allweight}}
\index{comp\_\-allweight@{comp\_\-allweight}!spc_optimum.c@{spc\_\-optimum.c}}
...
\label{spc__optimum_8c_a670955b1949d9ed6a54528c55b2d7bfe}
...
693 }
\end{DoxyCode}
\hypertarget{spc__optimum_8c_a4da3f4712620de5171d7a0daa5f0bf61}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!compute\_\-modvar@{compute\_\-modvar}}
\index{compute\_\-modvar@{compute\_\-modvar}!spc_optimum.c@{spc\_\-optimum.c}}
...
\label{spc__optimum_8c_a4da3f4712620de5171d7a0daa5f0bf61}
...
179 }
\end{DoxyCode}
\hypertarget{spc__optimum_8c_a507edca311317b7c885a40aff09a4e34}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!compute\_\-object\_\-ivar@{compute\_\-object\_\-ivar}}
\index{compute\_\-object\_\-ivar@{compute\_\-object\_\-ivar}!spc_optimum.c@{spc\_\-optimum.c}}
...
\label{spc__optimum_8c_a507edca311317b7c885a40aff09a4e34}
...
279 }
\end{DoxyCode}
\hypertarget{spc__optimum_8c_aa900417c8629b95d35d362ca481c5483}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!compute\_\-total\_\-ivar@{compute\_\-total\_\-ivar}}
\index{compute\_\-total\_\-ivar@{compute\_\-total\_\-ivar}!spc_optimum.c@{spc\_\-optimum.c}}
...
\label{spc__optimum_8c_aa900417c8629b95d35d362ca481c5483}
...
336 }
\end{DoxyCode}
\hypertarget{spc__optimum_8c_a1dc967d6de4c0d294342ef5124da686e}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!get\_\-all\_\-dims@{get\_\-all\_\-dims}}
\index{get\_\-all\_\-dims@{get\_\-all\_\-dims}!spc_optimum.c@{spc\_\-optimum.c}}
...
\label{spc__optimum_8c_a1dc967d6de4c0d294342ef5124da686e}
...
424 }
\end{DoxyCode}
\hypertarget{spc__optimum_8c_a48973ed3e4aa7384e047f4d75ee06582}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!get\_\-default\_\-dim@{get\_\-default\_\-dim}}
\index{get\_\-default\_\-dim@{get\_\-default\_\-dim}!spc_optimum.c@{spc\_\-optimum.c}}
\subsubsection[{get\_\-default\_\-dim}]{\setlength{\rightskip}{0pt plus 5cm}{\bf drzstamp\_\-dim} get\_\-default\_\-dim ()}}
\label{spc__optimum_8c_a48973ed3e4aa7384e047f4d75ee06582}
...
535 }
\end{DoxyCode}
\hypertarget{spc__optimum_8c_aef1186ac7f985de47fe8cd962a4381b8}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!get\_\-default\_\-modvar@{get\_\-default\_\-modvar}}
\index{get\_\-default\_\-modvar@{get\_\-default\_\-modvar}!spc_optimum.c@{spc\_\-optimum.c}}
\subsubsection[{get\_\-default\_\-modvar}]{\setlength{\rightskip}{0pt plus 5cm}{\bf drzstamp}$\ast$ get\_\-default\_\-modvar ()}}
\label{spc__optimum_8c_aef1186ac7f985de47fe8cd962a4381b8}
...
569 }
\end{DoxyCode}
\hypertarget{spc__optimum_8c_a6f7e58438e5ed0d86dcaa2f170db30c9}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!get\_\-default\_\-weight@{get\_\-default\_\-weight}}
\index{get\_\-default\_\-weight@{get\_\-default\_\-weight}!spc_optimum.c@{spc\_\-optimum.c}}
\subsubsection[{get\_\-default\_\-weight}]{\setlength{\rightskip}{0pt plus 5cm}gsl\_\-matrix$\ast$ get\_\-default\_\-weight ()}}
\label{spc__optimum_8c_a6f7e58438e5ed0d86dcaa2f170db30c9}
...
581 }
\end{DoxyCode}
\hypertarget{spc__optimum_8c_a925a44a925643f7770807b6352ae5109}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!get\_\-resample\_\-dims@{get\_\-resample\_\-dims}}
\index{get\_\-resample\_\-dims@{get\_\-resample\_\-dims}!spc_optimum.c@{spc\_\-optimum.c}}
...
\label{spc__optimum_8c_a925a44a925643f7770807b6352ae5109}
...
510 }
\end{DoxyCode}
\hypertarget{spc__optimum_8c_a1f6715d47ee4f6ff176974c14dc6401c}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!prepare\_\-inv\_\-variance@{prepare\_\-inv\_\-variance}}
\index{prepare\_\-inv\_\-variance@{prepare\_\-inv\_\-variance}!spc_optimum.c@{spc\_\-optimum.c}}
...
\label{spc__optimum_8c_a1f6715d47ee4f6ff176974c14dc6401c}
...
233 }
\end{DoxyCode}
\hypertarget{spc__optimum_8c_aa3e8e6e9854df4de96ee44cbacfad4a8}{
\index{spc\_\-optimum.c@{spc\_\-optimum.c}!shift\_\-tracelength@{shift\_\-tracelength}}
\index{shift\_\-tracelength@{shift\_\-tracelength}!spc_optimum.c@{spc\_\-optimum.c}}
\subsubsection[{shift\_\-tracelength}]{\setlength{\rightskip}{0pt plus 5cm}void shift\_\-tracelength ({\bf ap\_\-pixel} $\ast$ {\em ap\_\-p}, \/  const double {\em xi\_\-shift})}}
\label{spc__optimum_8c_aa3e8e6e9854df4de96ee44cbacfad4a8}
...
184   ap_pixel *cur_p;
185 
186   // go over each PET pixel
187   for (cur_p = ap_p; cur_p->p_x != -1; cur_p++)
188     {
189       // apply a shift in trace distance
190       cur_p->xi += xi_shift;
191     }
192 }
\end{DoxyCode}

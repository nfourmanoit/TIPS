\hypertarget{spc__fluxcube_8c}{
\section{/renoir/fourmano/Desktop/OUSIM/TIPS/branches/tips\_\-build/src/axesim/spc\_\-fluxcube.c File Reference}
\label{spc__fluxcube_8c}\index{/renoir/fourmano/Desktop/OUSIM/TIPS/branches/tips\_\-build/src/axesim/spc\_\-fluxcube.c@{/renoir/fourmano/Desktop/OUSIM/TIPS/branches/tips\_\-build/src/axesim/spc\_\-fluxcube.c}}
}
...
\begin{DoxyCompactItemize}
\item 
\#define \hyperlink{spc__fluxcube_8c_aacc3ee1a7f283f8ef65cea31f4436a95}{MAX}(x, y)~(((x)$>$(y))?(x):(y))
\item 
\#define \hyperlink{spc__fluxcube_8c_a74e75242132eaabbc1c512488a135926}{MIN}(x, y)~(((x)$<$(y))?(x):(y))
\item 
\#define \hyperlink{spc__fluxcube_8c_aa7866fa5e4e0ee9b034e9dab6599a9cc}{SQR}(x)~((x)$\ast$(x))
\end{DoxyCompactItemize}
\subsection*{Functions}
\begin{DoxyCompactItemize}
\item 
\hyperlink{structflux__cube}{flux\_\-cube} $\ast$ \hyperlink{spc__fluxcube_8c_ab4f88c30f07f1b2e86e3c156ae495691}{load\_\-fluxcube} (const char fcube\_\-file\mbox{[}$\,$\mbox{]})
\item 
\hyperlink{structflux__cube}{flux\_\-cube} $\ast$ \hyperlink{spc__fluxcube_8c_ad34f3325fb0c75b628a15f8dfb856b61}{alloc\_\-fluxcube} (const int nflux)
\item 
int \hyperlink{spc__fluxcube_8c_a20041a83ddc2d8aa08695983981141ba}{load\_\-offsets} (const char fcube\_\-file\mbox{[}$\,$\mbox{]}, \hyperlink{structflux__cube}{flux\_\-cube} $\ast$fcube)
\item 
gsl\_\-matrix\_\-int $\ast$ \hyperlink{spc__fluxcube_8c_a80aa93013c03ce8ca7d5a2fddf0ed404}{load\_\-segmentation} (const char fcube\_\-file\mbox{[}$\,$\mbox{]})
\item 
\hyperlink{structflux__image}{flux\_\-image} $\ast$ \hyperlink{spc__fluxcube_8c_ab25b98aa66e43bc8a965e7ee056795ed}{load\_\-fluximage} (const char fcube\_\-file\mbox{[}$\,$\mbox{]}, int hdunum)
\item 
gsl\_\-vector\_\-int $\ast$ \hyperlink{spc__fluxcube_8c_a5c1a750847b6040abc13eeabb47585b2}{order\_\-fluxims} (\hyperlink{structflux__cube}{flux\_\-cube} $\ast$fcube)
\item 
void \hyperlink{spc__fluxcube_8c_a4326413c31d848f7f10076d3776b2d08}{free\_\-fluxcube} (\hyperlink{structflux__cube}{flux\_\-cube} $\ast$fcube)
\item 
void \hyperlink{spc__fluxcube_8c_a106c1cdd426ec4412413f3926a69e825}{free\_\-fluximage} (\hyperlink{structflux__image}{flux\_\-image} $\ast$fimage)
\item 
\hyperlink{structd__point}{d\_\-point} \hyperlink{spc__fluxcube_8c_a350fb76c81c3285d1978f350e3a0fe8b}{flt\_\-to\_\-fcube\_\-trans} (const \hyperlink{structflux__cube}{flux\_\-cube} $\ast$fcube, const \hyperlink{structd__point}{d\_\-point} flt\_\-point)
\item 
\hyperlink{structd__point}{d\_\-point} \hyperlink{spc__fluxcube_8c_adbcfc42b8b653d54a14f17e4de25619d}{fcube\_\-to\_\-flt\_\-trans} (const \hyperlink{structflux__cube}{flux\_\-cube} $\ast$fcube, const \hyperlink{structd__point}{d\_\-point} fcube\_\-point)
\item 
\hyperlink{structdirobject}{dirobject} $\ast$$\ast$ \hyperlink{spc__fluxcube_8c_a682c533a63bf1a76022725edab374764}{fluxcube\_\-to\_\-dirlist} (const \hyperlink{structflux__cube}{flux\_\-cube} $\ast$fcube, \hyperlink{structobject}{object} $\ast$$\ast$oblist)
\item 
\hyperlink{structdirobject}{dirobject} $\ast$ \hyperlink{spc__fluxcube_8c_ad1a7873ace1a14d664bf453c76e27411}{dirobject\_\-from\_\-segpoint} (const \hyperlink{structpx__point}{px\_\-point} flt\_\-point, const \hyperlink{structobject}{object} $\ast$actobject)
\item 
void \hyperlink{spc__fluxcube_8c_ad90a902ccd2f90598490b151687c579a}{update\_\-dirobject} (\hyperlink{structdirobject}{dirobject} $\ast$actdir, const \hyperlink{structpx__point}{px\_\-point} flt\_\-point)
\item 
void \hyperlink{spc__fluxcube_8c_aecabb3459b749d8e33ea85f4e0bcfcbe}{fill\_\-xy\_\-offsets} (\hyperlink{structdirobject}{dirobject} $\ast$$\ast$dirlist, char CONF\_\-file\mbox{[}$\,$\mbox{]})
\item 
void \hyperlink{spc__fluxcube_8c_a2177a42473f70dd15e8fd25315589552}{fill\_\-fluxvalues} (const \hyperlink{structflux__cube}{flux\_\-cube} $\ast$fcube, const \hyperlink{structpx__point}{px\_\-point} point, \hyperlink{structdirobject}{dirobject} $\ast$actdir, const int inter\_\-type)
\item 
void \hyperlink{spc__fluxcube_8c_aeb6a2b975b5359734fec27bef4d60d3e}{print\_\-fluxcube} (const \hyperlink{structflux__cube}{flux\_\-cube} $\ast$fcube)
\end{DoxyCompactItemize}


\subsection{Define Documentation}
\hypertarget{spc__fluxcube_8c_aacc3ee1a7f283f8ef65cea31f4436a95}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!MAX@{MAX}}
\index{MAX@{MAX}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
\subsubsection[{MAX}]{\setlength{\rightskip}{0pt plus 5cm}\#define MAX(x, \/  y)~(((x)$>$(y))?(x):(y))}}
\label{spc__fluxcube_8c_aacc3ee1a7f283f8ef65cea31f4436a95}
\hypertarget{spc__fluxcube_8c_a74e75242132eaabbc1c512488a135926}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!MIN@{MIN}}
\index{MIN@{MIN}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
\subsubsection[{MIN}]{\setlength{\rightskip}{0pt plus 5cm}\#define MIN(x, \/  y)~(((x)$<$(y))?(x):(y))}}
\label{spc__fluxcube_8c_a74e75242132eaabbc1c512488a135926}
\hypertarget{spc__fluxcube_8c_aa7866fa5e4e0ee9b034e9dab6599a9cc}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!SQR@{SQR}}
\index{SQR@{SQR}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
\subsubsection[{SQR}]{\setlength{\rightskip}{0pt plus 5cm}\#define SQR(x)~((x)$\ast$(x))}}
\label{spc__fluxcube_8c_aa7866fa5e4e0ee9b034e9dab6599a9cc}


\subsection{Function Documentation}
\hypertarget{spc__fluxcube_8c_ad34f3325fb0c75b628a15f8dfb856b61}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!alloc\_\-fluxcube@{alloc\_\-fluxcube}}
\index{alloc\_\-fluxcube@{alloc\_\-fluxcube}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
\subsubsection[{alloc\_\-fluxcube}]{\setlength{\rightskip}{0pt plus 5cm}{\bf flux\_\-cube}$\ast$ alloc\_\-fluxcube (const int {\em nflux})}}
\label{spc__fluxcube_8c_ad34f3325fb0c75b628a15f8dfb856b61}
...
109 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_ad1a7873ace1a14d664bf453c76e27411}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!dirobject\_\-from\_\-segpoint@{dirobject\_\-from\_\-segpoint}}
\index{dirobject\_\-from\_\-segpoint@{dirobject\_\-from\_\-segpoint}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
...
\label{spc__fluxcube_8c_ad1a7873ace1a14d664bf453c76e27411}
...
568 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_adbcfc42b8b653d54a14f17e4de25619d}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!fcube\_\-to\_\-flt\_\-trans@{fcube\_\-to\_\-flt\_\-trans}}
\index{fcube\_\-to\_\-flt\_\-trans@{fcube\_\-to\_\-flt\_\-trans}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
...
\label{spc__fluxcube_8c_adbcfc42b8b653d54a14f17e4de25619d}
...
414 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_a2177a42473f70dd15e8fd25315589552}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!fill\_\-fluxvalues@{fill\_\-fluxvalues}}
\index{fill\_\-fluxvalues@{fill\_\-fluxvalues}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
...
\label{spc__fluxcube_8c_a2177a42473f70dd15e8fd25315589552}
...
724 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_aecabb3459b749d8e33ea85f4e0bcfcbe}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!fill\_\-xy\_\-offsets@{fill\_\-xy\_\-offsets}}
\index{fill\_\-xy\_\-offsets@{fill\_\-xy\_\-offsets}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
...
\label{spc__fluxcube_8c_aecabb3459b749d8e33ea85f4e0bcfcbe}
...
655 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_a350fb76c81c3285d1978f350e3a0fe8b}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!flt\_\-to\_\-fcube\_\-trans@{flt\_\-to\_\-fcube\_\-trans}}
\index{flt\_\-to\_\-fcube\_\-trans@{flt\_\-to\_\-fcube\_\-trans}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
...
\label{spc__fluxcube_8c_a350fb76c81c3285d1978f350e3a0fe8b}
...
393 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_a682c533a63bf1a76022725edab374764}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!fluxcube\_\-to\_\-dirlist@{fluxcube\_\-to\_\-dirlist}}
\index{fluxcube\_\-to\_\-dirlist@{fluxcube\_\-to\_\-dirlist}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
...
\label{spc__fluxcube_8c_a682c533a63bf1a76022725edab374764}
...
518 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_a4326413c31d848f7f10076d3776b2d08}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!free\_\-fluxcube@{free\_\-fluxcube}}
\index{free\_\-fluxcube@{free\_\-fluxcube}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
\subsubsection[{free\_\-fluxcube}]{\setlength{\rightskip}{0pt plus 5cm}void free\_\-fluxcube ({\bf flux\_\-cube} $\ast$ {\em fcube})}}
\label{spc__fluxcube_8c_a4326413c31d848f7f10076d3776b2d08}
...
352 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_a106c1cdd426ec4412413f3926a69e825}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!free\_\-fluximage@{free\_\-fluximage}}
\index{free\_\-fluximage@{free\_\-fluximage}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
\subsubsection[{free\_\-fluximage}]{\setlength{\rightskip}{0pt plus 5cm}void free\_\-fluximage ({\bf flux\_\-image} $\ast$ {\em fimage})}}
\label{spc__fluxcube_8c_a106c1cdd426ec4412413f3926a69e825}
...
372 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_ab4f88c30f07f1b2e86e3c156ae495691}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!load\_\-fluxcube@{load\_\-fluxcube}}
\index{load\_\-fluxcube@{load\_\-fluxcube}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
...
\label{spc__fluxcube_8c_ab4f88c30f07f1b2e86e3c156ae495691}
...
86 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_ab25b98aa66e43bc8a965e7ee056795ed}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!load\_\-fluximage@{load\_\-fluximage}}
\index{load\_\-fluximage@{load\_\-fluximage}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
...
\label{spc__fluxcube_8c_ab25b98aa66e43bc8a965e7ee056795ed}
...
240 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_a20041a83ddc2d8aa08695983981141ba}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!load\_\-offsets@{load\_\-offsets}}
\index{load\_\-offsets@{load\_\-offsets}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
...
\label{spc__fluxcube_8c_a20041a83ddc2d8aa08695983981141ba}
...
152 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_a80aa93013c03ce8ca7d5a2fddf0ed404}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!load\_\-segmentation@{load\_\-segmentation}}
\index{load\_\-segmentation@{load\_\-segmentation}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
...
\label{spc__fluxcube_8c_a80aa93013c03ce8ca7d5a2fddf0ed404}
...
199 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_a5c1a750847b6040abc13eeabb47585b2}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!order\_\-fluxims@{order\_\-fluxims}}
\index{order\_\-fluxims@{order\_\-fluxims}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
...
\label{spc__fluxcube_8c_a5c1a750847b6040abc13eeabb47585b2}
...
317 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_aeb6a2b975b5359734fec27bef4d60d3e}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!print\_\-fluxcube@{print\_\-fluxcube}}
\index{print\_\-fluxcube@{print\_\-fluxcube}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
\subsubsection[{print\_\-fluxcube}]{\setlength{\rightskip}{0pt plus 5cm}void print\_\-fluxcube (const {\bf flux\_\-cube} $\ast$ {\em fcube})}}
\label{spc__fluxcube_8c_aeb6a2b975b5359734fec27bef4d60d3e}
...
746 }
\end{DoxyCode}
\hypertarget{spc__fluxcube_8c_ad90a902ccd2f90598490b151687c579a}{
\index{spc\_\-fluxcube.c@{spc\_\-fluxcube.c}!update\_\-dirobject@{update\_\-dirobject}}
\index{update\_\-dirobject@{update\_\-dirobject}!spc_fluxcube.c@{spc\_\-fluxcube.c}}
...
\label{spc__fluxcube_8c_ad90a902ccd2f90598490b151687c579a}

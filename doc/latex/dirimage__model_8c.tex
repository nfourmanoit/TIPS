\hypertarget{dirimage__model_8c}{
\section{/renoir/fourmano/Desktop/OUSIM/TIPS/branches/tips\_\-build/src/axesim/dirimage\_\-model.c File Reference}
\label{dirimage__model_8c}\index{/renoir/fourmano/Desktop/OUSIM/TIPS/branches/tips\_\-build/src/axesim/dirimage\_\-model.c@{/renoir/fourmano/Desktop/OUSIM/TIPS/branches/tips\_\-build/src/axesim/dirimage\_\-model.c}}
}
...
\begin{DoxyCompactItemize}
\item 
\#define \hyperlink{dirimage__model_8c_aacc3ee1a7f283f8ef65cea31f4436a95}{MAX}(x, y)~(((x)$>$(y))?(x):(y))
\item 
\#define \hyperlink{dirimage__model_8c_a74e75242132eaabbc1c512488a135926}{MIN}(x, y)~(((x)$<$(y))?(x):(y))
\item 
\#define \hyperlink{dirimage__model_8c_aa7866fa5e4e0ee9b034e9dab6599a9cc}{SQR}(x)~((x)$\ast$(x))
\end{DoxyCompactItemize}
\subsection*{Functions}
\begin{DoxyCompactItemize}
\item 
int \hyperlink{dirimage__model_8c_aa37b4c8ff6adfc45892cc21f774a0881}{compute\_\-dirimage\_\-modelOld} (char dirim\_\-file\mbox{[}$\,$\mbox{]}, char conf\_\-file\mbox{[}$\,$\mbox{]}, char tpass\_\-file\mbox{[}$\,$\mbox{]}, char specmod\_\-file\mbox{[}$\,$\mbox{]}, char objmod\_\-file\mbox{[}$\,$\mbox{]}, char aper\_\-file\mbox{[}$\,$\mbox{]}, const double model\_\-scale, const double tel\_\-area, const double lambda\_\-psf, \hyperlink{structobservation}{observation} $\ast$obs, char map\_\-file\mbox{[}$\,$\mbox{]})
\item 
int \hyperlink{dirimage__model_8c_a3f6b812b097d2c09646b47c7b3beb445}{compute\_\-dirimage\_\-model} (char dirim\_\-file\mbox{[}$\,$\mbox{]}, char conf\_\-file\mbox{[}$\,$\mbox{]}, char tpass\_\-file\mbox{[}$\,$\mbox{]}, char specmod\_\-file\mbox{[}$\,$\mbox{]}, char objmod\_\-file\mbox{[}$\,$\mbox{]}, char aper\_\-file\mbox{[}$\,$\mbox{]}, const double model\_\-scale, const double tel\_\-area, const double lambda\_\-psf, \hyperlink{structobservation}{observation} $\ast$obs, char map\_\-file\mbox{[}$\,$\mbox{]})
\item 
void \hyperlink{dirimage__model_8c_a371e3a170621827e2ec09b3746df0ffb}{make\_\-dirimage\_\-object} (\hyperlink{structobject}{object} $\ast$actobject, \hyperlink{structdirobject}{dirobject} $\ast$actdir, \hyperlink{structinterpolator}{interpolator} $\ast$tpass, gsl\_\-matrix $\ast$dirimage\_\-matrix)
\item 
gsl\_\-matrix $\ast$ \hyperlink{dirimage__model_8c_a18d35af5ae5d98dcf27d0ef9b47cfdf0}{make\_\-dirimage} (\hyperlink{structobject}{object} $\ast$$\ast$oblist, \hyperlink{structdirobject}{dirobject} $\ast$$\ast$dirlist, const \hyperlink{structpx__point}{px\_\-point} npixels, const double lambda\_\-psf, \hyperlink{structinterpolator}{interpolator} $\ast$tpass)
\item 
double \hyperlink{dirimage__model_8c_a35f00ade0db1ab9b955eb2daa34a1c8f}{get\_\-cps\_\-for\_\-dirobject} (\hyperlink{structinterpolator}{interpolator} $\ast$tpass, \hyperlink{structdirobject}{dirobject} $\ast$actdir)
\item 
double \hyperlink{dirimage__model_8c_af910d0984d034fc1377290e01bdaf1a5}{integrate\_\-interpolator} (\hyperlink{structinterpolator}{interpolator} $\ast$combine)
\item 
\hyperlink{structinterpolator}{interpolator} $\ast$ \hyperlink{dirimage__model_8c_af16f00a45c2122acf9e354440470502f}{combine\_\-tpass\_\-SED} (\hyperlink{structinterpolator}{interpolator} $\ast$tpass, \hyperlink{structdirobject}{dirobject} $\ast$actdir)
\item 
\hyperlink{structinterpolator}{interpolator} $\ast$ \hyperlink{dirimage__model_8c_ad920380d8766ba433e531afd159f5ed4}{get\_\-combined\_\-tpass\_\-SED} (gsl\_\-vector $\ast$indep\_\-data, \hyperlink{structinterpolator}{interpolator} $\ast$tpass, \hyperlink{structdirobject}{dirobject} $\ast$actdir)
\item 
\hyperlink{structinterpolator}{interpolator} $\ast$ \hyperlink{dirimage__model_8c_a9ad9a6858c9a87180afb5cddfbdab204}{get\_\-filter\_\-sensitivity} (const char tpass\_\-file\mbox{[}$\,$\mbox{]}, const double tel\_\-area)
\end{DoxyCompactItemize}


\subsection{Define Documentation}
\hypertarget{dirimage__model_8c_aacc3ee1a7f283f8ef65cea31f4436a95}{
\index{dirimage\_\-model.c@{dirimage\_\-model.c}!MAX@{MAX}}
\index{MAX@{MAX}!dirimage_model.c@{dirimage\_\-model.c}}
\subsubsection[{MAX}]{\setlength{\rightskip}{0pt plus 5cm}\#define MAX(x, \/  y)~(((x)$>$(y))?(x):(y))}}
\label{dirimage__model_8c_aacc3ee1a7f283f8ef65cea31f4436a95}
\hypertarget{dirimage__model_8c_a74e75242132eaabbc1c512488a135926}{
\index{dirimage\_\-model.c@{dirimage\_\-model.c}!MIN@{MIN}}
\index{MIN@{MIN}!dirimage_model.c@{dirimage\_\-model.c}}
\subsubsection[{MIN}]{\setlength{\rightskip}{0pt plus 5cm}\#define MIN(x, \/  y)~(((x)$<$(y))?(x):(y))}}
\label{dirimage__model_8c_a74e75242132eaabbc1c512488a135926}
\hypertarget{dirimage__model_8c_aa7866fa5e4e0ee9b034e9dab6599a9cc}{
\index{dirimage\_\-model.c@{dirimage\_\-model.c}!SQR@{SQR}}
\index{SQR@{SQR}!dirimage_model.c@{dirimage\_\-model.c}}
\subsubsection[{SQR}]{\setlength{\rightskip}{0pt plus 5cm}\#define SQR(x)~((x)$\ast$(x))}}
\label{dirimage__model_8c_aa7866fa5e4e0ee9b034e9dab6599a9cc}


\subsection{Function Documentation}
\hypertarget{dirimage__model_8c_af16f00a45c2122acf9e354440470502f}{
\index{dirimage\_\-model.c@{dirimage\_\-model.c}!combine\_\-tpass\_\-SED@{combine\_\-tpass\_\-SED}}
\index{combine\_\-tpass\_\-SED@{combine\_\-tpass\_\-SED}!dirimage_model.c@{dirimage\_\-model.c}}
...
\label{dirimage__model_8c_af16f00a45c2122acf9e354440470502f}
...
568 }
\end{DoxyCode}
\hypertarget{dirimage__model_8c_a3f6b812b097d2c09646b47c7b3beb445}{
\index{dirimage\_\-model.c@{dirimage\_\-model.c}!compute\_\-dirimage\_\-model@{compute\_\-dirimage\_\-model}}
\index{compute\_\-dirimage\_\-model@{compute\_\-dirimage\_\-model}!dirimage_model.c@{dirimage\_\-model.c}}
\subsubsection[{compute\_\-dirimage\_\-model}]{\setlength{\rightskip}{0pt plus 5cm}int compute\_\-dirimage\_\-model (char {\em dirim\_\-file}\mbox{[}$\,$\mbox{]}, \/  char {\em conf\_\-file}\mbox{[}$\,$\mbox{]}, \/  char {\em tpass\_\-file}\mbox{[}$\,$\mbox{]}, \/  char {\em specmod\_\-file}\mbox{[}$\,$\mbox{]}, \/  char {\em objmod\_\-file}\mbox{[}$\,$\mbox{]}, \/  char {\em aper\_\-file}\mbox{[}$\,$\mbox{]}, \/  const double {\em model\_\-scale}, \/  const double {\em tel\_\-area}, \/  const double {\em lambda\_\-psf}, \/  {\bf observation} $\ast$ {\em obs}, \/  char {\em map\_\-file}\mbox{[}$\,$\mbox{]})}}
\label{dirimage__model_8c_a3f6b812b097d2c09646b47c7b3beb445}
...
280 }
\end{DoxyCode}
\hypertarget{dirimage__model_8c_aa37b4c8ff6adfc45892cc21f774a0881}{
\index{dirimage\_\-model.c@{dirimage\_\-model.c}!compute\_\-dirimage\_\-modelOld@{compute\_\-dirimage\_\-modelOld}}
\index{compute\_\-dirimage\_\-modelOld@{compute\_\-dirimage\_\-modelOld}!dirimage_model.c@{dirimage\_\-model.c}}
\subsubsection[{compute\_\-dirimage\_\-modelOld}]{\setlength{\rightskip}{0pt plus 5cm}int compute\_\-dirimage\_\-modelOld (char {\em dirim\_\-file}\mbox{[}$\,$\mbox{]}, \/  char {\em conf\_\-file}\mbox{[}$\,$\mbox{]}, \/  char {\em tpass\_\-file}\mbox{[}$\,$\mbox{]}, \/  char {\em specmod\_\-file}\mbox{[}$\,$\mbox{]}, \/  char {\em objmod\_\-file}\mbox{[}$\,$\mbox{]}, \/  char {\em aper\_\-file}\mbox{[}$\,$\mbox{]}, \/  const double {\em model\_\-scale}, \/  const double {\em tel\_\-area}, \/  const double {\em lambda\_\-psf}, \/  {\bf observation} $\ast$ {\em obs}, \/  char {\em map\_\-file}\mbox{[}$\,$\mbox{]})}}
\label{dirimage__model_8c_aa37b4c8ff6adfc45892cc21f774a0881}
...
116 }
\end{DoxyCode}
\hypertarget{dirimage__model_8c_ad920380d8766ba433e531afd159f5ed4}{
\index{dirimage\_\-model.c@{dirimage\_\-model.c}!get\_\-combined\_\-tpass\_\-SED@{get\_\-combined\_\-tpass\_\-SED}}
\index{get\_\-combined\_\-tpass\_\-SED@{get\_\-combined\_\-tpass\_\-SED}!dirimage_model.c@{dirimage\_\-model.c}}
...
\label{dirimage__model_8c_ad920380d8766ba433e531afd159f5ed4}
...
638 }
\end{DoxyCode}
\hypertarget{dirimage__model_8c_a35f00ade0db1ab9b955eb2daa34a1c8f}{
\index{dirimage\_\-model.c@{dirimage\_\-model.c}!get\_\-cps\_\-for\_\-dirobject@{get\_\-cps\_\-for\_\-dirobject}}
\index{get\_\-cps\_\-for\_\-dirobject@{get\_\-cps\_\-for\_\-dirobject}!dirimage_model.c@{dirimage\_\-model.c}}
...
\label{dirimage__model_8c_a35f00ade0db1ab9b955eb2daa34a1c8f}
...
477 }
\end{DoxyCode}
\hypertarget{dirimage__model_8c_a9ad9a6858c9a87180afb5cddfbdab204}{
\index{dirimage\_\-model.c@{dirimage\_\-model.c}!get\_\-filter\_\-sensitivity@{get\_\-filter\_\-sensitivity}}
\index{get\_\-filter\_\-sensitivity@{get\_\-filter\_\-sensitivity}!dirimage_model.c@{dirimage\_\-model.c}}
...
\label{dirimage__model_8c_a9ad9a6858c9a87180afb5cddfbdab204}
...
681 }
\end{DoxyCode}
\hypertarget{dirimage__model_8c_af910d0984d034fc1377290e01bdaf1a5}{
\index{dirimage\_\-model.c@{dirimage\_\-model.c}!integrate\_\-interpolator@{integrate\_\-interpolator}}
\index{integrate\_\-interpolator@{integrate\_\-interpolator}!dirimage_model.c@{dirimage\_\-model.c}}
...
\label{dirimage__model_8c_af910d0984d034fc1377290e01bdaf1a5}
...
497 }
\end{DoxyCode}
\hypertarget{dirimage__model_8c_a18d35af5ae5d98dcf27d0ef9b47cfdf0}{
\index{dirimage\_\-model.c@{dirimage\_\-model.c}!make\_\-dirimage@{make\_\-dirimage}}
\index{make\_\-dirimage@{make\_\-dirimage}!dirimage_model.c@{dirimage\_\-model.c}}
...
\label{dirimage__model_8c_a18d35af5ae5d98dcf27d0ef9b47cfdf0}
...
454 }
\end{DoxyCode}
\hypertarget{dirimage__model_8c_a371e3a170621827e2ec09b3746df0ffb}{
\index{dirimage\_\-model.c@{dirimage\_\-model.c}!make\_\-dirimage\_\-object@{make\_\-dirimage\_\-object}}
\index{make\_\-dirimage\_\-object@{make\_\-dirimage\_\-object}!dirimage_model.c@{dirimage\_\-model.c}}
...
\label{dirimage__model_8c_a371e3a170621827e2ec09b3746df0ffb}
